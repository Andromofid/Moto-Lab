<form method="GET" action="{{ route('motos.index') }}">
    ...
    <div class="grid gap-4 lg:grid-cols-[1.4fr_1fr_1fr_1fr]">
        ...
        <div>
            <label
                for="q"
                class="text-xs font-bold uppercase tracking-[0.18em] text-moto-muted">
                Recherche
            </label>
    ...
    <div class="mt-4 grid gap-4 md:grid-cols-3 lg:grid-cols-[1fr_1fr_1fr_auto]">
        ...
        <div class="flex items-end gap-3">
            ...
            <button
                type="submit"
                class="inline-flex min-h-12 flex-1 items-center justify-center rounded-xl bg-primary-600 px-5 py-3 text-sm font-bold text-white transition hover:bg-primary-700">
                Filtrer
            </button>

            <a
                href="{{ route('motos.index') }}"
                class="inline-flex min-h-12 items-center justify-center rounded-xl border border-moto-border px-5 py-3 text-sm font-semibold text-moto-muted transition hover:border-primary-600 hover:bg-moto-surface-light hover:text-white">
                Reset
            </a>
