...
<head>
    ...
    <title>Contact - Moto Lab Casablanca</title>

    <meta
        name="description"
        content="Contactez Moto Lab Casablanca pour une moto, une disponibilité showroom ou une demande d'information.">
...
<body class="bg-moto-black text-moto-text antialiased">
    ...
    <main>
        <section class="relative overflow-hidden border-b border-moto-border">
            <div class="pointer-events-none absolute -right-28 -top-28 h-96 w-96 rounded-full bg-primary-600/20 blur-[120px] lg:h-[560px] lg:w-[560px]"></div>
        ...
        <section class="mx-auto grid max-w-7xl gap-8 px-4 py-10 sm:px-6 lg:grid-cols-[0.9fr_1.1fr] lg:px-8 lg:py-16">
            <aside class="space-y-5">
                <div class="rounded-3xl border border-moto-border bg-moto-surface p-6 shadow-xl shadow-black/10">
                ...
                <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-1">
                    <div class="rounded-2xl border border-moto-border bg-moto-surface p-5">
                        <p class="text-xs font-bold uppercase tracking-[0.18em] text-moto-muted">Adresse</p>
                        <p class="mt-2 font-semibold text-white">Oulfa, Casablanca</p>
                    </div>

                    <div class="rounded-2xl border border-moto-border bg-moto-surface p-5">
                        <p class="text-xs font-bold uppercase tracking-[0.18em] text-moto-muted">Téléphone</p>
                        <p class="mt-2 font-semibold text-white">+212 6 89 49 75 06</p>
                        <p class="mt-2 font-semibold text-white">+212 6 84 60 25 60</p>
                    </div>

                    <div class="rounded-2xl border border-moto-border bg-moto-surface p-5">
                        <p class="text-xs font-bold uppercase tracking-[0.18em] text-moto-muted">Téléphone Fixe</p>
                        <p class="mt-2 font-semibold text-white">+212 5 22 89 72 57</p>
             
                    </div>

                    <div class="rounded-2xl border border-moto-border bg-moto-surface p-5">
                        <p class="text-xs font-bold uppercase tracking-[0.18em] text-moto-muted">Email</p>
                        <p class="mt-2 font-semibold text-white">contact@motolab.ma</p>
                    </div>

                    <div class="rounded-2xl border border-moto-border bg-moto-surface p-5">
                        <p class="text-xs font-bold uppercase tracking-[0.18em] text-moto-muted">Réponse</p>
                        <p class="mt-2 font-semibold text-white">Sous 24h ouvrées</p>
                    </div>
                </div>
            </aside>

            <section class="rounded-3xl border border-moto-border bg-moto-surface p-6 shadow-2xl shadow-black/20 sm:p-8">
                ...
                <form method="POST" action="{{ route('contact.store') }}" class="mt-6 space-y-5">
                    ...
                    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                        <p class="text-xs leading-5 text-moto-muted">
