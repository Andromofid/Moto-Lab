...
<head>
    ...
    <title>Catalogue motos - Moto Lab Casablanca</title>

    <meta
        name="description"
        content="Explorez le catalogue Moto Lab Casablanca avec filtres par marque, catégorie, condition et prix.">
...
<body class="bg-moto-black text-moto-text antialiased">
    ...
    <main>
        <section class="relative overflow-hidden border-b border-moto-border">
            <div class="pointer-events-none absolute -right-28 -top-28 h-80 w-80 rounded-full bg-primary-600/20 blur-[110px] lg:h-[520px] lg:w-[520px]"></div>
            <div class="pointer-events-none absolute bottom-0 left-10 h-72 w-72 rounded-full bg-white/5 blur-[100px]"></div>

            <div class="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
                <div class="max-w-3xl">
                    <span class="inline-flex rounded-full border border-primary-600/30 bg-primary-600/10 px-4 py-2 text-xs font-bold uppercase tracking-[0.22em] text-primary-400">
                        Catalogue Moto Lab
                    </span>
                    ...
                    <p class="mt-5 max-w-2xl text-base leading-7 text-moto-muted sm:text-lg">
        ...
        <section class="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
            <div class="rounded-2xl border border-moto-border bg-moto-surface shadow-2xl shadow-black/20">
                ...
                <details class="group lg:hidden">
                    <summary
                        ...
                        <div class="flex items-center gap-3">
                            <div class="flex h-10 w-10 items-center justify-center rounded-xl bg-primary-600/10 text-primary-500">
                                <svg
                        ...
                        <svg
                            ...
                            stroke-width="2"
                            stroke="currentColor"
                            class="h-5 w-5 text-moto-muted transition-transform duration-200 group-open:rotate-180">
                            <path
                                stroke-linecap="round"
                                stroke-linejoin="round"
                    ...
                    <div class="border-t border-moto-border p-4">
            ...
            <div class="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <article class="group overflow-hidden rounded-3xl border border-moto-border bg-moto-surface transition duration-300 hover:-translate-y-1 hover:border-primary-600/70 hover:shadow-2xl hover:shadow-primary-600/10">
                    <div class="relative flex h-64 items-center justify-center overflow-hidden bg-moto-black">
                        ...
                        @if ($moto->is_featured)
                        <span class="absolute right-4 top-4 rounded-full bg-primary-600 px-3 py-1 text-xs font-bold text-white">
                            Vedette
                        </span>
                        @endif
                    </div>
                    ...
                    <div class="p-6">
                        <div class="flex flex-wrap items-center gap-2 text-xs font-bold uppercase tracking-[0.16em] text-primary-500">
                        ...
                        <div class="mt-5 grid grid-cols-3 gap-3 rounded-2xl border border-moto-border bg-moto-black/50 p-3 text-center">
                            <div>
                                <p class="text-[10px] font-bold uppercase tracking-widest text-moto-muted">Année</p>
                                <p class="mt-1 text-sm font-semibold text-white">{{ $moto->year ?? '-' }}</p>
                            </div>

                            <div>
                                <p class="text-[10px] font-bold uppercase tracking-widest text-moto-muted">CC</p>
                                <p class="mt-1 text-sm font-semibold text-white">{{ $moto->engine_cc ?? '-' }}</p>
                            </div>

                            <div>
                                <p class="text-[10px] font-bold uppercase tracking-widest text-moto-muted">Km</p>
                        ...
                        <div class="mt-5 flex items-center justify-between gap-4">
                            <div>
                                <p class="text-xs text-moto-muted">Prix</p>
            ...
            <div class="mt-8 rounded-3xl border border-moto-border bg-moto-surface px-6 py-16 text-center">
                <div class="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-primary-600/10 font-heading text-2xl font-bold text-primary-500">
                    M
                </div>
                ...
                <p class="mx-auto mt-3 max-w-md text-sm leading-6 text-moto-muted">
                    Essayez d'élargir les filtres ou de revenir au catalogue complet.
                </p>

                <a
                    href="{{ route('motos.index') }}"
                    class="mt-6 inline-flex rounded-xl bg-primary-600 px-5 py-3 text-sm font-bold text-white transition hover:bg-primary-700">
